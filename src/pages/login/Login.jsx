...
const Login = () => {
  ...
  return (
    <div className='min-h-screen flex' style={{ backgroundColor: '#1c1c1c' }}>
      ...
      {/* ── Right Form Panel ── */}
      <div
        className='w-full xl:w-1/2 flex flex-col items-center justify-center min-h-screen px-5 py-20 md:px-10 xl:px-12 2xl:px-16 relative overflow-hidden'
        style={{
          background:
            'radial-gradient(ellipse 100% 70% at 80% 50%, rgba(255,101,51,0.07) 0%, transparent 60%), #1c1c1c',
        }}
      >
        {/* Animated vertical lines — contained to this panel */}
        <div
          className='absolute inset-0 pointer-events-none z-0'
          aria-hidden='true'
        >

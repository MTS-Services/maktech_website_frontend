...
const CaseStudyHero = () => (
  <div className='relative flex flex-col items-center justify-center min-h-screen px-5 pt-28 pb-16 text-center overflow-hidden'>
    ...
    {/* Heading */}
    <h1 className='relative z-10 text-white font-bold leading-tight tracking-tight text-[clamp(2rem,5.5vw,4.5rem)] max-w-5xl mb-6'>
      Featured Project Case Studies
    </h1>

    {/* Subheading */}
    <p className='relative z-10 text-white/70 text-base xl:text-lg max-w-xl leading-relaxed mb-10'>
      A closer look at the projects where strategy, creativity,

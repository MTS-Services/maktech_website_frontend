...
const AboutTeam = () => (
  ...
  >
    ...
    <div className="relative z-10 max-w-360 mx-auto w-full">
      ...
      {/* Divider */}
      <div className="flex items-center gap-5 my-12 max-w-7xl mx-auto w-full">
      ...
      {/* Directors row — 4 cards */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 max-w-7xl mx-auto w-full">

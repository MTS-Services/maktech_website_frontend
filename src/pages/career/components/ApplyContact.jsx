                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-4'>
                  <div>
                    ...
                    >
                      ...
                      >
                        <option value='Fresher' className='bg-[#3F3F3F]'>
                          Fresher
                        </option>
                        <option value='1 year' className='bg-[#3F3F3F]'>
                          1 year
                        </option>
                        <option value='2 years' className='bg-[#3F3F3F]'>
                          2 years
                        </option>
                        <option value='3 years' className='bg-[#3F3F3F]'>
                          3 years
                        </option>
                        <option value='4 years' className='bg-[#3F3F3F]'>
                          4 years
                        </option>
                        <option value='5 years' className='bg-[#3F3F3F]'>
                          5 years
                        </option>
                        <option value='5+ years' className='bg-[#3F3F3F]'>
                          5+ years
